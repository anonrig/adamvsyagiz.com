...
One-page site for the **$5,000 Spring Break Fitness Challenge**.
...
{"weight":282.4,"waist":49,"stepDays":5,"pushUps":20,"pullUps":2,"walkingLunges":9}
```
...
Optional fields: `week`, `date`, `weight`, `waist`, `stepDays`, `pushUps`, `pullUps`, `walkingLunges`, `note`, `sampleId`. Walking lunges are reps per leg at the prescribed load. Send at least one value. Form posts from `/log` work too.
